...
#
# Generated by Vivado on Thu Jul 16 12:22:36 +0530 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="E:/Acadamics/Semester 7/HDL/HDL-project/HDL-mean-filter/HDL-mean-filter.cache/compile_simlib/activehdl"
  fi
