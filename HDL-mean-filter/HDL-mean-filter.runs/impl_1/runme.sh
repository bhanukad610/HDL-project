...
HD_PWD='E:/Acadamics/Semester 7/HDL/HDL-project/HDL-mean-filter/HDL-mean-filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mean_filter_with_bram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mean_filter_with_bram.tcl -notrace
